...
import { HomeIcon, CircleIcon } from "lucide-react"
...
export default async function RootLayout({
  ...
  const session =
     skip_auth ? {user:null} : await getAuth()
  ...
  let data = {
    ...
    nav_main: [
      ...
      {
        title: "Cream Cheese",
        url: "/dashboard/cream-cheese",
        icon: <CircleIcon />,
        isActive: true,
        items: [
          {
            title: "Fermentation explorer",
            url: "/dashboard/cream-cheese/fermentation-explorer",
          }
        ],
      },
    ],
